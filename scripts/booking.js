...
$("#btnContinue").click(function () {
  if ($("#nameInput").val() == null || $("#nameInput").val() == "") {
    ...
    $("#waNumberInput").val() == null ||
    $("#waNumberInput").val() == ""
  ) {
    $("#WAVal").show();
    $("#WAVal").html("Silahkan isi nomor WA.");
  } else if (
    document.getElementById("ddlNumberofPersonInput").value == null ||
    document.getElementById("ddlNumberofPersonInput").value == ""
  ) {
    $("#numberPersonVal").show();
    $("#numberPersonVal").html("Silahkan isi jumlah orang.");
  } else if (
    document.getElementById("ddlNumberofClothesInput").value == null ||
    document.getElementById("ddlNumberofClothesInput").value == ""
  ) {
    $("#numberClothesVal").show();
    $("#numberClothesVal").html("Silahkan isi jumlah tema baju.");
  } else if (
    document.getElementById("ddlPhotoThemeInput").value == null ||
    document.getElementById("ddlPhotoThemeInput").value == ""
  ) {
    $("#photoThemeVal").show();
  ...
  if (
    document.getElementById("ddlNumberofPersonInput").value == "16-30" ||
    document.getElementById("ddlNumberofClothesInput").value == "3+"
  ) {
    $("#ddlDurationInput").append(
      $("<option selected />").val("").text("--Pilih durasi--")
    );
    ...
    $("#lblDescDuration").html(
      "Anda tidak bisa memilih sesi 1 jam foto karena jumlah orang lebih dari 15 atau jumlah tema baju lebih dari 2. Karena durasi 1 jam tidak akan cukup."
    );
  } else {
    $("#ddlDurationInput").append(
      $("<option selected />").val("").text("--Pilih durasi--")
